...
// src/index.cjs.ts
var { PrismaHighlighter: PrismaHighlighter2 } = (init_highlighter(), __toCommonJS(highlighter_exports));
module.exports = { PrismaHighlighter: PrismaHighlighter2 };
module.exports.default = new PrismaHighlighter2();
